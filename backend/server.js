...
const app = express();
app.use(cors());
app.use(express.json({ limit: '10mb' })); // Permite o recebimento de fotos da câmera
...
// Checa se o e-mail já existe ao criar conta
...
// Login com o Google (Redireciona para o app dos pais)
app.get('/auth/google', (req, res) => {
  res.redirect('https://serene-tapioca-0f5fac.netlify.app/app-pais/');
});

// Cadastrar Aluno (Valida rigorosamente os 11 dígitos do CPF)
app.post('/api/cadastrar-aluno', (req, res) => {
  ...
  return res.status(201).json({ 
    mensagem: 'Seu familiar foi cadastrado, quando ele entrar a escola você saberá' 
  });
});

// Registro de Ponto enviado pelo Tablet da Sala
...
// Consulta de registros pelo app dos pais
